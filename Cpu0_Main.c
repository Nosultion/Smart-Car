...
//        ATOM_PWM_SetDuty(ATOMPWM6, 0, 17000);
       ...
       //蜂鸣器
//       if(motor_flag==1||Circle_flag==3||Circle_flag==4||)
//       {
//           //测试识别元素鸣叫
...
//       else if(Obstacle_flag==2||Obstacle_flag==3||open_flag==2||Park_flag==1||Park_flag==2)
//       {
//           //元素过程闪鸣
//           BUZZ_Ctrl(BUZZ0,BUZZ_RVS);
//       }
       else
       {
       ...
       //电磁出赛道停车
       if(MagneticField<1000&&Obstacle_flag==0&&motor_flag==2)
       {
          start_V_L=0;
          motor_flag=0;
          BUZZ_Ctrl(BUZZ0,BUZZ_OFF);
...
>>>>>>> 7ad945c0e831c2aae21445f8162953f2f4787e70
